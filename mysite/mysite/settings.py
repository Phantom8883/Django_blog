...
SECRET_KEY = 'django-insecure-5h_rwbb3o=e%=56vz3-7cn*v7vj*&_j7!#80$0x=*&t8dov187'
...
INSTALLED_APPS = [
    'account.apps.AccountConfig',  # Первым! Чтобы наши шаблоны переопределяли стандартные
